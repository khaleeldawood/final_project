...
<div class="container py-4" style="margin-top: 100px;">
  <div class="row mb-4">
    <div class="col">
      ...
      <div id="badgesProgress" class="alert alert-info d-none" style="background-color: rgba(6, 182, 212, 0.15); border-color: rgba(6, 182, 212, 0.3);">
        <strong style="color: var(--text-primary);">Your Progress:</strong> <span style="color: var(--text-primary);" id="badgesPoints">0 points earned</span>
      </div>
    </div>
  </div>
