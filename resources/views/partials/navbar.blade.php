  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarMain">
      ...
      <ul class="navbar-nav ms-auto align-items-lg-center">
        <li class="nav-item" data-auth="user">
          <a class="nav-link position-relative" href="/notifications">Notifications</a>
        </li>
        <li class="nav-item">
          <button class="btn btn-link nav-link theme-toggle" type="button" data-theme-toggle title="Toggle theme">??</button>
        </li>
        ...
        <li class="nav-item dropdown" data-auth="user">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
            ...
            <li><hr class="dropdown-divider" data-role-any="SUPERVISOR,ADMIN"></li>
            <li data-role-any="SUPERVISOR,ADMIN"><a class="dropdown-item" href="/events/approvals">Event Approvals</a></li>
            <li data-role-any="SUPERVISOR,ADMIN"><a class="dropdown-item" href="/blogs/approvals">Blog Approvals</a></li>
            <li data-role-any="SUPERVISOR,ADMIN"><a class="dropdown-item" href="/reports">Reports</a></li>
            <li><hr class="dropdown-divider" data-role="ADMIN"></li>
