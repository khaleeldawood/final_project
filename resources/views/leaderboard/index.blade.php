        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="btn-group w-100" role="group">
              <button class="btn btn-primary" id="leaderboardTypeMembers"><i class="bi bi-people"></i> Members</button>
              <button class="btn btn-outline-primary" id="leaderboardTypeEvents"><i class="bi bi-calendar-event"></i>
                Events</button>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-body">
            ...
            <div class="btn-group w-100" role="group">
              <button class="btn btn-outline-primary" id="leaderboardScopeUniversity"><i class="bi bi-building"></i> My
                University</button>
              <button class="btn btn-primary" id="leaderboardScopeGlobal"><i class="bi bi-globe"></i> Global</button>
            </div>
          </div>
        </div>
      </div>
