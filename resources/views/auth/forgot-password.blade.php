...
@section('content')
<div id="forgotPasswordContainer" class="container d-flex align-items-center justify-content-center" style="min-height: 100vh; margin-top: 150px; margin-bottom: 100px;">
  <div class="card" style="max-width: 500px; width: 100%;">
    <div class="card-body p-5">
      <div id="forgotPasswordFormPanel">
        <div class="text-center mb-4">
          <h2 style="font-size: 2rem; font-weight: 700;">?? Forgot Password</h2>
      ...
      <div id="forgotPasswordSuccessPanel" class="text-center d-none">
        ...
        <p class="text-muted mb-4">
          If an account exists with <strong id="forgotPasswordSuccessEmail"></strong>, you will receive a password reset link shortly.
        </p>
